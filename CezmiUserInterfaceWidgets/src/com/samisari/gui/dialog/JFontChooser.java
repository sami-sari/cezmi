...
public class JFontChooser extends JPanel {
	...
	private static LinkedHashMap<String, Font>	recentFonts					= new LinkedHashMap<String, Font>();
	...
	private JComboBox<String>	recentFontCombo		= null;
	...
	public void setSelectedFontFamily(String name) {
		...
		updateSampleFont();
		changeSupport.firePropertyChange("selectedFont", null, getSelectedFont());
	}
	...
	public void setSelectedFont(Font font) {
		...
		changeSupport.firePropertyChange("selecedFont", oldFont, font);
	}
	...
	protected class DialogOKAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			recentFonts.put(fontNameList.getSelectedValue() + " " + fontSizeList.getSelectedValue() + " " + fontStyleList.getSelectedValue(), JFontChooser.this.getSelectedFont());
	...
	protected void updateSampleFont() {
		...
		changeSupport.firePropertyChange("selectedFont", null, font);
	}
	...
	protected JTextArea getSampleTextField() {
		if (sampleText == null) {
			Border lowered = BorderFactory.createLoweredBevelBorder();

			sampleText = new JTextArea(("AaBbYyZz"));
	...
	public String[] getText() {
		String t = getSampleTextField().getText();
		return t.split("\\n");
	}
	...
	public void setText(String[] text) {
		...
		getSampleTextField().setText(txt);
	}
